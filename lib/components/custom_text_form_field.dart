...
class _CustomTextFormFieldState extends State<CustomTextFormField> {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      decoration: widget.inputDecoration ?? InputDecoration(
        ...
        fillColor: widget.fillColor ?? Theme.of(context).cardColor.withOpacity(0.2),
  ...
  OutlineInputBorder getBorder() => OutlineInputBorder(
    ...
    borderSide: BorderSide(
      ...
      color: widget.outlineInputBorderColor ?? Theme.of(context).colorScheme.primary.withOpacity(0.3),
    ),
  );
}
