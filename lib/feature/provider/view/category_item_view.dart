...
class CategorySection extends StatelessWidget {
  ...
  const CategorySection({Key? key, required this.category, this.providerData,}) : super(key: key);
      ...
      Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
        ...
        ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            return ServiceWidgetVertical(service:  category.serviceList[index],  isAvailable: isAvailable,fromType: 'provider_details', providerData: providerData,);
          },
        ),
      ]):const SizedBox(),
    );
